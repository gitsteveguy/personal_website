...
const portfolio = [
  ...
  gridAppender = async (e, t, a = "gallery") => {
    ...
    t.forEach((e) => {
      ...
      if ("gallery" === a) {
        ...
        (s.src = e.img),
          (s.loading = "lazy"),
          Object.hasOwn(e, "darkLogo") && s.setAttribute("class", "cg-icon"),
          t.append(s);
        ...
        if ((p.setAttribute("class", "portfolio-btns"), e.playstore)) {
          let g = createLinkButton(
            e.playstore,
            "",
        ...
        if (e.website) {
          let c = createLinkButton(e.website, "View", "");
          c.setAttribute("class", "primary-btn neon-eff"), p.append(c);
        }
        if (e.appstore) {
          let m = createLinkButton(
            e.appstore,
            "",
        ...
        p.children.length > 0 && t.append(p);
      }
      i.appendChild(t);
    }),
      e.appendChild(i);
  ...
  createLinkButton = (e, t, a) => {
    ...
    if (((i.href = e), (i.target = "_blank"), a)) {
      let s = document.createElement("img");
      (s.src = a), i.append(s);
    }
    if ("" != t) {
      let o = document.createElement("span");
      (o.innerText = t), i.append(o);
    }
    return i;
  };
...
window.addEventListener(
  ...
  () => {
    ...
    sections.forEach((t) => {
      let a = t.offsetTop;
      pageYOffset >= a - 200 && (e = t.getAttribute("id"));
    }),
      e !== lastActive &&
        ((lastActive = e),
        links.forEach((t) => {
